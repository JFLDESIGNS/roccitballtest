...
export const MOVEMENT = {
  ...
  grappleMaxHorizontalSpeedSprintMul: 7.5,
  grappleSwingDrive: 36,
  grappleSwingDamping: 0.985,
  grappleArcadeSpeedSprintMul: 7.35,
  grappleArcadeAccel: 18,
  grappleArcadeLiftAccel: 16,
  grappleArcadeInputBlend: 0.35,
  grapplePendulumAngularSpeed: 3.2,
  grapplePendulumFollow: 5.6,
  grapplePendulumMinRadius: 10,
  grapplePendulumMaxRadius: 32,
